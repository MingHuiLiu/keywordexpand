all:
	...
	g++ -o checktask checktask.cpp check.cpp ../log/log.cpp model.cpp sql.cpp lz.cpp ../commom/func.cpp -I ../../software/xapian/include/ -I /usr/include/mysql/ -I /data/qspace/seanxywang/software/include/  -L /usr/lib64/mysql/ -L /home/qspace/lib/ -lcurl -levent -l xapian -l mysqlclient
clean:
